...
export class UserViewComponent implements OnInit {
  ...
  columns: STColumn[] = [
    ...
    { title: 'Email', index: 'email', width: 250 },
  ...
  constructor(private auth: AuthenticationService, private router: Router, public http: _HttpClient, public message: NzMessageService) {
